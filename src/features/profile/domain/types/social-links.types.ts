...
export const DEFAULT_SOCIAL_PLATFORMS: readonly SocialPlatformDefinition[] = [
  ...
  },
  {
    ...
    validation: SOCIAL_PLATFORM_VALIDATION_PATTERNS.INSTAGRAM,
    category: 'social',
    priority: 4,
    isUrlType: true,
    extractUsername: (url: string) => url.split('/').pop() || '',
  },
  {
    ...
    validation: SOCIAL_PLATFORM_VALIDATION_PATTERNS.FACEBOOK,
    category: 'social',
    priority: 5,
    isUrlType: true,
    extractUsername: (url: string) => url.split('/').pop() || '',
  },
  {
    ...
    validation: SOCIAL_PLATFORM_VALIDATION_PATTERNS.YOUTUBE,
    category: 'creative',
    priority: 6,
    isUrlType: true,
    extractUsername: (url: string) => url.split('/').pop() || '',
  },
  {
    ...
    validation: SOCIAL_PLATFORM_VALIDATION_PATTERNS.BEHANCE,
    category: 'creative',
    priority: 7,
    isUrlType: true,
    extractUsername: (url: string) => url.split('/').pop() || '',
  },
  {
    ...
    validation: SOCIAL_PLATFORM_VALIDATION_PATTERNS.DRIBBBLE,
    category: 'creative',
    priority: 8,
    isUrlType: true,
    extractUsername: (url: string) => url.split('/').pop() || '',
  },
  {
    ...
    validation: SOCIAL_PLATFORM_VALIDATION_PATTERNS.MEDIUM,
    category: 'professional',
    priority: 9,
    isUrlType: true,
    extractUsername: (url: string) => url.replace('@', '').split('/').pop() || '',
  },
  {
    key: 'tiktok',
    name: 'TikTok',
    ...
    validation: SOCIAL_PLATFORM_VALIDATION_PATTERNS.TIKTOK,
    category: 'social',
    priority: 10,
    isUrlType: true,
    extractUsername: (url: string) => url.replace('@', '').split('/').pop() || '',
  },
  {
    ...
    validation: SOCIAL_PLATFORM_VALIDATION_PATTERNS.WEBSITE,
    category: 'personal',
    priority: 11,
    isUrlType: true,
    extractUsername: (url: string) => new URL(url).hostname || '',
  },
  {
    key: 'portfolio',
    name: 'Portfolio',
    ...
    validation: SOCIAL_PLATFORM_VALIDATION_PATTERNS.PORTFOLIO,
    category: 'personal',
    priority: 12,
    isUrlType: true,
    extractUsername: (url: string) => new URL(url).hostname || '',
